...
## 第2章 java内存区域与内存溢出一场
### 运行时数据区域
![这里写图片描述](http://d17znh8lvwja9e.cloudfront.net/understand-the-jvm/1.jpg)
#### 程序计数器
记录当前线程执行字节码的行号
- 每个线程拥有一个
...
![通过句柄访问对象](http://d17znh8lvwja9e.cloudfront.net/understand-the-jvm/2.jpg)
2. 通过直接指针访问对象（HotSpot）
![直接指针访问对象](http://d17znh8lvwja9e.cloudfront.net/understand-the-jvm/3.jpg)
...
![HotSpot收集器](http://d17znh8lvwja9e.cloudfront.net/understand-the-jvm/4.jpg)

#### Serial收集器 
![Serial/Serial Old收集器运行示意图](http://d17znh8lvwja9e.cloudfront.net/understand-the-jvm/5.jpg)
- 新生代
- 适合单个处理器，适合client模式
- 单线程
...
#### ParNew收集器
![ParNew-Serial Old收集器运行示意图](http://d17znh8lvwja9e.cloudfront.net/understand-the-jvm/6.jpg)
- 新生代
- 多线程，适合多核处理器
- Server模式比较好
...
![Parallel Scavenge+Parallel Old收集器](http://d17znh8lvwja9e.cloudfront.net/understand-the-jvm/7.jpg)
- 新生代
- 并行多线程
- 使用复制算法的收集器
- 关注吞吐量。
...
#### CMS收集器 
![CMS收集器](http://d17znh8lvwja9e.cloudfront.net/understand-the-jvm/8.jpg)
...
#### G1 收集器
![G1收集器](http://d17znh8lvwja9e.cloudfront.net/understand-the-jvm/9.jpg)
面向服务器端的收集器。
优点：
