...
假设这个栈一直增长，增长后如下图所示
!![这里写图片描述](http://d17znh8lvwja9e.cloudfront.net/java-memory-leak/1.jpg)

当进行大量的pop操作时，由于引用未进行置空，gc是不会释放的，如下图所示
![这里写图片描述](http://d17znh8lvwja9e.cloudfront.net/java-memory-leak/2.jpg)
...
```
一旦引用过期，清空这些引用，将引用置空。
![这里写图片描述](http://d17znh8lvwja9e.cloudfront.net/java-memory-leak/3.jpg)
...
**/
```
![这里写图片描述](http://d17znh8lvwja9e.cloudfront.net/java-memory-leak/4.jpg)
