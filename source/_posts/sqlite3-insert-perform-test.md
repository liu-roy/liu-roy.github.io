...
![这里写图片描述](http://d17znh8lvwja9e.cloudfront.net/sqlite3-insert-perform-test/1.jpg)
![这里写图片描述](http://d17znh8lvwja9e.cloudfront.net/sqlite3-insert-perform-test/2.jpg)

## 慢插入-暴力插入
![这里写图片描述](http://d17znh8lvwja9e.cloudfront.net/sqlite3-insert-perform-test/3.jpg)
<!--more-->
...
## 事务插入-显示的开启事务
![这里写图片描述](http://d17znh8lvwja9e.cloudfront.net/sqlite3-insert-perform-test/4.jpg)
所谓”事务“就是指一组SQL命令，这些命令要么一起执行，要么都不被执行。如果在插入数据前显式开启事务，插入后再一起提交，则会大大提高IO效率，进而加数据快插入速度。

## 同步关闭模式-synchronous = OFF
![这里写图片描述](http://d17znh8lvwja9e.cloudfront.net/sqlite3-insert-perform-test/5.jpg)
...
![这里写图片描述](http://d17znh8lvwja9e.cloudfront.net/sqlite3-insert-perform-test/6.jpg)
...
## 测试结果展示
![这里写图片描述](http://d17znh8lvwja9e.cloudfront.net/sqlite3-insert-perform-test/7.jpg)
## 测试源代码
```c++
extern "C"
{
